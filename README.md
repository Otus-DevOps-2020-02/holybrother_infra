...
Для удобного подключения используем jump до локального хоста, предварительно настроив SSH forwarding ssh -J professional@35.246.113.27 professional@10.154.0.3
# Config
...
# CONNECT
bastion_IP = 35.246.113.27 someinternalhost_IP = 10.154.0.3
