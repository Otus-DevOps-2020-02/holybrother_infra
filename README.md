...
Host bastion        User professional        PreferredAuthentications publickey        IdentityFile ~/.ssh/professional        Hostname 35.246.113.27Host bastionlocal        User professional        Hostname 10.154.0.3        ProxyJump bastion Подключаемся по ssh к bastion/bastionlocal Данные по подключению
